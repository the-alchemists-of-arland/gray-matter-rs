...
fn matter_yaml<D: serde::de::DeserializeOwned>(file_name: &str) -> Result<ParsedEntity<D>> {
...
#[test]
fn test_parse_complex_yaml_front_matter() -> Result<()> {
    #[derive(serde::Deserialize, PartialEq, Debug)]
    struct FrontMatter {
        root: String,
        assets: String,
...
#[test]
fn test_parse_no_matter() -> Result<()> {
